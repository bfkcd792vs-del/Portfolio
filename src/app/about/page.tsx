...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "shristirajpoot369@gmail.com",
    href: "mailto:shristirajpoot369@gmail.com",
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/shristi-rajpoot-36774b281/",
    content: "/shristi-rajpoot-36774b281",
    icon: <FaLinkedin height={"50px"} />,
  },
  {
    name: "GitHub",
    href: "https://github.com/Shristirajpoot",
    content: "/Shristirajpoot",
          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              ...
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">Shristi Rajpoot</p>
<div className="text-xs bg-zinc-700 w-fit px-3 py-1 rounded-full">
  Software Engineer | CSE @ IIITDMJ
</div>
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
             Hey! I’m Shristi, a 6th semester Computer Science Engineering student at IIITDMJ.
I enjoy building full-stack applications and solving real-world problems using
modern web technologies. I’m particularly interested in backend systems,
scalable architectures, and applied AI.

            </p>
            <p className="mb-10">
             Outside coding, I actively participate in competitive programming, hackathons,
and open-source contributions. I’m always eager to learn, experiment, and
